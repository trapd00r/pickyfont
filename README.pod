...
=head2 Typeface
  ...
  Typeface can be any of normal, bold, italic, or simply 'all'
...
Therefore I see no other way then to keeping a (configuration)? file with more
...
Other then that, there are some more or less good programming fonts in the
...
pickyfont homepage: http://github.com/trapd00r/pickyfont
